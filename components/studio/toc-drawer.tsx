...
export function TocDrawer({
  ...
  return (
    <div className="fixed inset-y-0 right-0 z-40 w-[85vw] sm:w-72 border-l border-neutral-200 dark:border-neutral-800 bg-white/95 dark:bg-neutral-900/95 p-4 shadow-2xl backdrop-blur-md flex flex-col">
